# Lore — Deep Research over Your Team's Slack Memory
...
**[Watch the 2.5-min demo → `lore-demo.mp4`](lore-demo.mp4)** — click the file on GitHub and it plays inline. It's a walkthrough of a real live run in the sandbox workspace: the assistant streams its research, then a Canvas surfaces the pricing reversal ($29 → $49) with every claim deep-linked to its source message.
...
The app runs in the **"Simon"** sandbox workspace. Access will be granted to **slackhack@salesforce.com** and **testing@devpost.com**.
